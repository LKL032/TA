...
#Reorder columns
MICUSP_by_filename <- select(MICUSP_by_filename, filename, discipline, nativeness, year, tense, aspect, TA, frequency) 
MICUSP_by_filename

#Save as CSV
write.csv(MICUSP_by_filename, 'MICUSP_by_filename1.csv')
